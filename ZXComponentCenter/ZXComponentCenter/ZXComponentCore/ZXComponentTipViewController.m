//
//  ZXComponentTipViewController.m
//  ZXComponentCenter
//
...
@interface ZXComponentTipViewController ()
...
@property (nonatomic, strong) UIButton *returnButton;@end

@implementation ZXComponentTipViewController
...
+(nonnull UIViewController *)paramsErrorTipController{
    ZXComponentTipViewController *controller = [[ZXComponentTipViewController alloc] init];
